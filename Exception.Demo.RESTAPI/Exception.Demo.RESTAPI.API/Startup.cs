using AutoMapper;
using Exception.Demo.RESTAPI.API.Common.Attributes;
using Exception.Demo.RESTAPI.API.Common.Extensions;
using Exception.Demo.RESTAPI.API.Common.Settings;
using Exception.Demo.RESTAPI.IoC.Configuration.Profiles;
...
using System.IO;
using Exception.Demo.RESTAPI.API.Controllers;
using Microsoft.AspNetCore.Mvc.Versioning.Conventions;
using Exception.Demo.RESTAPI.API.Swagger;

namespace Exception.Demo.RESTAPI.API
{
